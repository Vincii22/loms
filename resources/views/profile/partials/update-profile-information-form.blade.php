<section>
    ...
    <form method="POST" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="school_id" name="school_id" type="text" class="mt-1 block w-full" :value="old('school_id', $user->school_id)" />
...
<div>
    ...
    <input id="barcode_image" name="barcode_image" type="file" class="mt-1 block w-full" accept="image/*" />
